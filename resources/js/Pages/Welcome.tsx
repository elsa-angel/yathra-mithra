          ...
          <div className='mt-16'>
            <div className='p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg mb-6 lg:mb-8'>
              ...
              >
                ...
                <button
                  type='submit'
                  className='bg-red-500 hover:bg-red-600 text-white font-semibold py-2 px-4 rounded-md transition duration-300 ease-in-out self-end sm:self-center'
                >
                  Search
                </button>
              </form>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8'>
              <a
                href={
                  auth.user ? 'https://laravel.com/docs' : route('register')
                }
